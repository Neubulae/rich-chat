...
public class ObfuscatedNode extends Node implements DelimitedNode {
	...
	public ObfuscatedNode() {
	}

	public ObfuscatedNode(BasedSequence chars) {
		super(chars);
	}

	public ObfuscatedNode(BasedSequence openingMarker, BasedSequence text, BasedSequence closingMarker) {
	...
	static class ObfuscatedDelimiterProcessor implements DelimiterProcessor {
		...
		public void process(Delimiter opener, Delimiter closer, int delimitersUsed) {
			ObfuscatedNode obfuscatedNode = new ObfuscatedNode(opener.getTailChars(delimitersUsed), BasedSequence.NULL,
					closer.getLeadChars(delimitersUsed));
			opener.moveNodesBetweenDelimitersTo(obfuscatedNode, closer);
		}
